defmodule AuthApiWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug AuthApiWeb.EnsureRolePlug, [:user, :admin]

      plug AuthApiWeb.EnsureRolePlug, :admin

      plug AuthApiWeb.EnsureRolePlug, ~w(user admin)a
  """
  import Plug.Conn
  ...
  defp maybe_halt(_any, conn) do
    conn
    |> put_status(401)
    |> json(%{error: %{code: 401, message: "Bad roles"}})
    |> halt()
  end
end
