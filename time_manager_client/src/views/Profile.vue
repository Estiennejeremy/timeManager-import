  ...
  methods: {
    ...
    init() {
      Promise.all([
        ...
        let sortyWorkingtimeByDay = this.sortWorkingtimesByWeekDays(
          weeklyWorkingtimes
        );

        let sortClockByDay = this.sortClocksByWeekDays(weeklyClocks);

        this.setWeeklyWorkingtimeChart(sortClockByDay);
      });
    },
  },
