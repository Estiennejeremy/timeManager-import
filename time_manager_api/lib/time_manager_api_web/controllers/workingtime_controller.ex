defmodule TimeManagerApiWeb.WorkingtimeController do
  ...
  def getAllWorkingtimeByteam(conn, %{"teamID" => teamID}) do
    workingtimes = Workingtimes.get_all_workingtime_by_team(teamID)
    render(conn, "index.json", workingtimes: workingtimes)
  end

  def getAllWorkingtimeByUser(conn, %{"userID" => userID}) do
    team = TimeManagerApi.Teams.get_team!(userID)
    workingtimes = Workingtimes.get_all_workingtime_by_team(team.id)
    render(conn, "index.json", workingtimes: workingtimes)
  end
