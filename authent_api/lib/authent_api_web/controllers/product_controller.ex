defmodule AuthentApiWeb.ProductController do
  use AuthentApiWeb, :controller

  alias AuthentApi.Inventory
  alias AuthentApi.Inventory.Product

  action_fallback AuthentApiWeb.FallbackController
